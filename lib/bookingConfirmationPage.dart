                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        color: Color.fromARGB(255, 1, 1, 123),
...
AppBar CarGoAppBar() {
  return AppBar(
    elevation: 0,
    backgroundColor: const Color.fromARGB(255, 0, 0, 122),
      ...
      children: [
        ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              backgroundColor: const Color.fromARGB(255, 0, 4, 127),
      ...
      children: [
        ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              backgroundColor: const Color.fromARGB(255, 7, 0, 132),
              foregroundColor: Colors.white,
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(30.0)),
            ),
